...
class ProductTemplate(models.Model):
    ...
    def _compute_bom_count(self):
        read_group_res = self.env['mrp.bom'].read_group([('product_tmpl_id', 'in', self.ids)], ['product_tmpl_id'],
                                                        ['product_tmpl_id'])
...
class ProductProduct(models.Model):
    ...
    def _compute_bom_count(self):
        read_group_res = self.env['mrp.bom'].read_group([('product_id', 'in', self.ids)], ['product_id'],
                                                        ['product_id'])
